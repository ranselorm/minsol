    ...
    <section className="pt-12 text-center">
      <div className="container mx-auto">
        <p className="max-w-2xl mx-auto mb-24 text-left text-lg text-grey">
          ...
          for always being at the forefront of innovation and technology, with
          the aim of providing new and better end-to-end solutions to our
          customers around the world, exceeding their expectations.
        </p>
          ...
          {stats.map((stat, index) => (
            <React.Fragment key={index}>
              <div className="flex flex-col items-center gap-y-4">
                ...
                {stat.linkText && (
                  <a href={stat.linkHref} className="text-secondary mt-2">
                    {stat.linkText}
                  </a>
                )}
              </div>
